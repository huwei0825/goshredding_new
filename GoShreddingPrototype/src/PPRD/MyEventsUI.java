...
public class MyEventsUI extends javax.swing.JFrame {
    ...
    public MyEventsUI() {
        ...
        event1.eventName = "Stoke Ski Centre";
        event1.eventDate = "01/02/2020";
        event1.eventTimeRemaining = "03 : 12 : 01";

        EventVO event2 = new EventVO();
        event2.eventName = "Clyne mtb";
        event2.eventDate = "02/02/2020";
        event2.eventTimeRemaining = "04 : 02 : 15";

        EventVO event3 = new EventVO();
        event3.eventName = "Swansea beach tour";
        event3.eventDate = "02/07/2020";
        event3.eventTimeRemaining = "04 : 03 : 01";

        EventVO event4 = new EventVO();
        event4.eventName = "The Snow Centre BP";
        event4.eventDate = "04/02/2020";
        event4.eventTimeRemaining = "06 : 03 : 01";

        EventVO event5 = new EventVO();
        event5.eventName = "Blackpill vert ramp";
        event5.eventDate = "08/02/2020";
        event5.eventTimeRemaining = "10 : 03 : 01";
